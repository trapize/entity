...
import { IConnectionFactory, IConnection, IPool, ConnectionSymbols } from '@trapize/connections';
...
export class Schema implements ISchema {
    ...
    public constructor(
        ...
        @inject(ConnectionSymbols.IConnectionFactory) private connFactory: IConnectionFactory,
